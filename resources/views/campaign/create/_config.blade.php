<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        ...
        <x-text-input id="email_list_id" class="block mt-1 w-full" name="email_list_id" :value="old('email_list_id', $data['email_list_id'])" autofocus />
    ...
    <div>
        ...
        <x-text-input id="template_id" class="block mt-1 w-full" name="template_id" :value="old('template_id', $data['template_id'])" autofocus />
